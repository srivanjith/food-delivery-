    ...
    <div className="relative overflow-hidden hero-gradient py-12 md:py-20 px-4 sm:px-6 lg:px-8 border-b border-slate-100 dark:border-slate-800/50 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          {/* Search Bar */}
          <div className="relative max-w-xl mx-auto lg:mx-0 shadow-lg shadow-slate-200/50 dark:shadow-none rounded-2xl">
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96 flex items-center justify-center animate-float">
            ...
            <div className="absolute w-60 h-60 sm:w-72 sm:h-72 bg-emerald-500/10 dark:bg-emerald-500/5 rounded-full filter blur-2xl" />
            <div className="absolute w-40 h-40 sm:w-52 sm:h-52 bg-teal-500/10 dark:bg-teal-500/5 rounded-full filter blur-xl" />

            {/* Glowing card panel */}
            <div className="relative glass-card p-6 w-64 sm:w-72 bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col justify-between items-center text-center">
